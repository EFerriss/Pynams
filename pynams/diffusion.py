...
class Diffusivities():
    ...
    ordered as [a, b, c, unoriented]. They can also be determined by the code
    for you [need to clarify by which functions]. 
    
    It can be convenient to link to compositional information here
    by specifying the sample.
    
    The basestyle and marker information are 
    just to change how the points show up when plotted on an Arrhenius diagram.
