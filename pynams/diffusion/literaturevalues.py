...
Library of diffusivities, both data and fit lines, and some functions to play
with them. The focus is on hydrogen diffusion in olivine and clinopyroxene.

function fast_vs_slow() provides a quick comparison of the fast and slow
